...
const CATEGORIES = [
  ...
  { id: "four-pin-non-duplicatable", name: "TENACITY 4-PIN locks with non-duplicatable keys" },
...
const PRODUCTS = [
  ...
  // ─── F6 SERIES 3-PIN LOCKS WITH NON-DUPLICATABLE KEYS ─────
  {
    ...
    features: ["F6 Series", "3-PIN Lock", "Non-Duplicatable Keys", "Main Door Lock", "Steel & Heavy Wooden Doors"],
    sku: "F6-BLACK",
  },
  {
    id: "f6-series-2",
  ...
  {
    id: "f6-series-3",
    name: "Tenacity F6 Series 3-PIN Lock GP/Gold — Non-Duplicatable Keys",
    category: "f6-series",
    price: 6500,
    originalPrice: null,
    onOffer: false,
  ...
  },
  {
    ...
    description: "Tenacity F6 Series 3-PIN lock colour range with non-duplicatable keys. Main door lock options ideal for steel doors and solid wooden mahogany heavy-duty doors, priced at KShs 6,500.",
    features: ["F6 Series", "Colour Range", "3-PIN Lock", "Non-Duplicatable Keys", "Main Door Lock"],
    sku: "F6-COLOUR-RANGE",
  },
  {
    id: "f6-series-5",
  ...
  {
    id: "f6-series-6",
    name: "Tenacity F6 Series 3-PIN Lock Colour Options Display — Non-Duplicatable Keys",
    category: "f6-series",
    price: 6500,
    originalPrice: null,
    onOffer: false,
    ...
    description: "Tenacity F6 Series 3-PIN lock colour options display with non-duplicatable keys. Main door lock options ideal for steel and solid wooden mahogany heavy-duty doors.",
    features: ["F6 Series", "Colour Options", "3-PIN Lock", "Non-Duplicatable Keys", "Main Door Lock"],
    sku: "F6-DISPLAY-01",
  },
  {
    id: "f6-series-7",
    name: "Tenacity F6 Series 3-PIN Lock Full Colour Range — Non-Duplicatable Keys",
    category: "f6-series",
    price: 6500,
    originalPrice: null,
    onOffer: false,
    ...
    description: "Tenacity F6 Series full colour range with non-duplicatable keys. Main door lock options ideal for steel and solid wooden mahogany heavy-duty doors.",
    features: ["F6 Series", "Full Colour Range", "3-PIN Lock", "Non-Duplicatable Keys", "Main Door Lock"],
    sku: "F6-FULL-RANGE",
  },
  ...
  // ─── TENACITY 4-PIN LOCKS WITH NON-DUPLICATABLE KEYS ─────
  {
    id: "tenacity-51-nbgp",
    ...
    images: ["assets/images/products/tenacity-51-nbgp.jpg"],
    ...
    features: ["4-Solid PIN lock", "Full brass 70mm cylinder", "2-in-1 double smartlock", "Non-duplicatable keys"],
    sku: "TENACITY-51-NBGP",
  },
  {
    id: "tenacity-62-acg",
    name: "Tenacity 62 ACG 4-PIN Lock with Non-duplicatable Keys",
    category: "four-pin-non-duplicatable",
    price: 9000,
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-62-acg.jpg",
    images: ["assets/images/products/tenacity-62-acg.jpg"],
    description: "Tenacity 62 ACG 4-Solid PIN lock with full brass 70mm cylinder, 2-in-1 double smartlock, and non-duplicatable keys.",
    features: ["4-Solid PIN lock", "Full brass 70mm cylinder", "2-in-1 double smartlock", "Non-duplicatable keys"],
    sku: "TENACITY-62-ACG",
  },
  {
    id: "tenacity-62-sncp",
    name: "Tenacity 62 SNCP 4-PIN Lock with Non-duplicatable Keys",
    category: "four-pin-non-duplicatable",
    price: 9000,
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-62-sncp.jpg",
    images: ["assets/images/products/tenacity-62-sncp.jpg"],
    description: "Tenacity 62 SNCP 4-Solid PIN lock with full brass 70mm cylinder, 2-in-1 double smartlock, and non-duplicatable keys.",
    features: ["4-Solid PIN lock", "Full brass 70mm cylinder", "2-in-1 double smartlock", "Non-duplicatable keys"],
    sku: "TENACITY-62-SNCP",
  },
  {
    id: "tenacity-90-abb",
    ...
    images: ["assets/images/products/tenacity-90-abb.jpg"],
  ...
  },
  {
    ...
    images: ["assets/images/products/tenacity-90-acc.jpg"],
  ...
  },
  {
    ...
    images: ["assets/images/products/tenacity-90-nbgp.jpg"],
  ...
  {
    id: "tenacity-259-mac",
    name: "Tenacity 259 MAC 4-PIN Lock with Non-duplicatable Keys",
    category: "four-pin-non-duplicatable",
    price: 8500,
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-259-mac.jpg",
    images: ["assets/images/products/tenacity-259-mac.jpg"],
    description: "Tenacity 259 MAC 4-Solid PIN lock with full brass 70mm cylinder, 2-in-1 double smartlock, and non-duplicatable keys.",
    features: ["4-Solid PIN lock", "Full brass 70mm cylinder", "2-in-1 double smartlock", "Non-duplicatable keys"],
    sku: "TENACITY-259-MAC",
  },
  {
    id: "tenacity-510-black",
    name: "Tenacity 510 Black 4-PIN Lock with Non-duplicatable Keys",
    category: "four-pin-non-duplicatable",
    price: 9500,
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-510-black.jpg",
    images: ["assets/images/products/tenacity-510-black.jpg"],
    description: "Tenacity 510 Black 4-Solid PIN lock with full brass 70mm cylinder, 2-in-1 double smartlock, and non-duplicatable keys.",
    features: ["4-Solid PIN lock", "Full brass 70mm cylinder", "2-in-1 double smartlock", "Non-duplicatable keys"],
    sku: "TENACITY-510-BLACK",
  },
  {
    id: "tenacity-510-mab",
    ...
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-510-mab.jpg",
    images: ["assets/images/products/tenacity-510-mab.jpg"],
  ...
  },
  {
    ...
    images: ["assets/images/products/tenacity-510-mac.jpg"],
  ...
  },
  {
    ...
    images: ["assets/images/products/tenacity-600-black.jpg"],
  ...
  },
  {
    ...
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-600-mab.jpg",
    images: ["assets/images/products/tenacity-600-mab.jpg"],
  ...
  {
    id: "tenacity-600-mac",
    name: "Tenacity 600 MAC 4-PIN Lock with Non-duplicatable Keys",
    category: "four-pin-non-duplicatable",
    price: 10000,
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-600-mac.jpg",
    images: ["assets/images/products/tenacity-600-mac.jpg"],
    description: "Tenacity 600 MAC 4-Solid PIN lock with full brass 70mm cylinder, 2-in-1 double smartlock, and non-duplicatable keys.",
    features: ["4-Solid PIN lock", "Full brass 70mm cylinder", "2-in-1 double smartlock", "Non-duplicatable keys"],
    sku: "TENACITY-600-MAC",
  },
  {
    id: "tenacity-600-mcf",
    ...
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-600-mcf.jpg",
    images: ["assets/images/products/tenacity-600-mcf.jpg"],
  ...
  {
    id: "tenacity-600-msn",
    name: "Tenacity 600 MSN 4-PIN Lock with Non-duplicatable Keys",
    category: "four-pin-non-duplicatable",
    price: 10000,
    originalPrice: null,
    onOffer: false,
    image: "assets/images/products/tenacity-600-msn.jpg",
    images: ["assets/images/products/tenacity-600-msn.jpg"],
    description: "Tenacity 600 MSN 4-Solid PIN lock with full brass 70mm cylinder, 2-in-1 double smartlock, and non-duplicatable keys.",
    features: ["4-Solid PIN lock", "Full brass 70mm cylinder", "2-in-1 double smartlock", "Non-duplicatable keys"],
    sku: "TENACITY-600-MSN",
  },
